...
export default async function Audit({ params }) {
  ...
  return (
    <div className="stack">
      ...
      <section className="grid"><article className="panel"><h2>Audit details</h2><p>Asset mode: one_time_audit</p><p>Environment: {audit.env}</p><p>Status: {audit.status}</p></article><article className="panel"><h2>Evidence posture</h2><b className="score">{audit.score}</b><Pill>{audit.severity}</Pill></article></section>
