...
if (!/auth\/me/.test(machineDetailClient) || !/adminCanManage/.test(machineDetailClient)) failures.push('managed machine detail must refresh admin permission client-side from /auth/me');
