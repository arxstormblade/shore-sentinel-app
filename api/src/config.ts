...
export const FEATURE_AREAS = ['central_dashboard','inventory_managed_machines','environments_grouping','managed_machine_schedules','scan_jobs_live_progress','reports_artifacts','import_export_reports','comparison_analytics','remediation_workflows','knowledgebase','logs_page','alert_rules','email_templates','smtp_settings','retention_policy','role_configuration','system_health_release_status'] as const;
