#!/usr/bin/env python3
"""
Agent_Security_Selfcheck_v3.5.0.py
===================================
...
REMEDIATION_PATHS = {
    ...
    "Framework deployment posture reviewed": "scripts/security-tools/agent-security-selfcheck/Agent_Security_Selfcheck_v3.5.0.py",
    ...
    "Risk Correlation / Cross-category audit coverage reviewed": "scripts/security-tools/agent-security-selfcheck/Agent_Security_Selfcheck_v3.5.0.py",
    "Persistence & Deployment / Framework persistence hooks reviewed": "scripts/security-tools/agent-security-selfcheck/Agent_Security_Selfcheck_v3.5.0.py",
}
...
def write_simple_pdf(path: Path, meta: dict[str, Any], res: dict[str, Any]) -> None:
    ...
    script_name = Path(str(meta.get("script_path", "Agent_Security_Selfcheck_v3.5.0.py"))).name
