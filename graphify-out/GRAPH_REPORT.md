# Graph Report - github-shore-sentinel-app  (2026-07-21)

## Corpus Check
- 211 files · ~268,694 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1999 nodes · 3055 edges · 162 communities (123 shown, 39 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 92 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `44adbfa7`
...
5. `MachineDetailClient()` - 20 edges
6. `DatabaseService` - 19 edges
7. `scripts` - 19 edges
8. `main()` - 19 edges
9. `write_simple_pdf()` - 18 edges
...
## Communities (162 total, 39 thin omitted)

### Community 0 - "AppController"
Cohesion: 0.05
Nodes (41): AppController, ARTIFACT_CONTENT_TYPES, assertSshEnrollment(), assertSshGrantControls(), parseSshPort(), PUBLIC_SCAN_RUN_EVENT, SshEnrollment, sshFingerprint() (+33 more)
...
Cohesion: 0.05
Nodes (41): 10. Phased delivery plan, 11. 95+ quality gate, 12. Approval boundary, 1. Executive direction, 2. Current-state findings that define the design, 3.1 Supported AI asset classes, 3.2 Explicit non-goals for the first enterprise release, 3.3 Add-machine function and SSH connection methods (+33 more)
...
### Community 12 - "service_block"
Cohesion: 0.10
Nodes (10): ComposeNetworkExposureTests, ComposeSmokeTests, ContainerHardeningTests, ImagePinningTests, LockfileReproducibleImageTests, MinioAccessTests, PrivateWorkerNetworkTests, ProductionSecretDeliveryTests (+2 more)

### Community 13 - "scanner-manifest.schema.json"
Cohesion: 0.06
Nodes (32): bundle, entrypoint, outputSchema, additionalProperties, properties, required, type, const (+24 more)

### Community 14 - "scripts"
Cohesion: 0.06
Nodes (30): name, overrides, postcss, private, scripts, api:build, api:check, api:test (+22 more)

### Community 15 - "Option 2 — App Deployment (install Shore Sentinel into Docker)"
Cohesion: 0.08
Nodes (24): 1. Clone the repository, 2. Configure environment values, 3. Validate the Compose model, 4. Start Shore Sentinel, 5. Check service health, 6. Stop the stack, Graphify navigation, Main app focus: managed machine monitoring (+16 more)

### Community 16 - "routePath"
Cohesion: 0.09
Nodes (11): KB(), SavedViewsPage(), SavedViewContent(), Brand(), Empty(), Header(), Shell(), ShoreLogo() (+3 more)

### Community 17 - "properties"
Cohesion: 0.07
Nodes (33): crit, critical, high, info, informational, low, medium, moderate (+25 more)

### Community 18 - "envdetect.py"
Cohesion: 0.33
Nodes (5): additionalProperties, $id, $schema, title, type

### Community 19 - "Shore Sentinel v1.1 SSH-Push Security Decision (Historical)"
Cohesion: 0.11
...
### Community 25 - "App-Wide Compact Operations Test Guide"
Cohesion: 0.12
...
### Community 27 - "Shore Sentinel UI/UX QA Loop"
Cohesion: 0.33
Nodes (6): collectedAt, findings, scanner, target, contractVersion, required

### Community 28 - "saved-views.jsx"
Cohesion: 0.19
...
### Community 29 - "Shore Sentinel Control Plane Architecture Proposal"
Cohesion: 0.12
...
### Community 30 - "Shore Sentinel Release Checklist"
Cohesion: 0.12
...
### Community 31 - "Managed Machine Compact Dossier Design"
Cohesion: 0.13
...
### Community 32 - "Feature Update and DevOps Release Workflow"
Cohesion: 0.13
...
### Community 36 - "ParserServerTests"
Cohesion: 0.09
...
### Community 38 - "DatabaseService"
Cohesion: 0.15
Nodes (6): DatabaseService, isWeakSecret(), REQUIRED_PRODUCTION_SECRETS, Injectable, validateProductionSecrets(), productionSecrets

### Community 39 - "Archon Protocol Telegram Coordination Policy"
Cohesion: 0.21
Nodes (6): AppModule, Injectable, UpdateMode, UpdateResult, UpdateService, Module

### Community 40 - "Changelog"
Cohesion: 0.15
Nodes (12): Changelog, Unreleased, v0.1.0, v0.1.1, v0.3.10, v0.3.5, v0.3.6, v0.3.7 (+4 more)

### Community 41 - "Shore Sentinel v1.1.0 — Managed Machine Scan Controls and Hardware Summary"
Cohesion: 0.15
...
### Community 43 - "Agent Security Self-Check"
Cohesion: 0.25
...
### Community 44 - "ARX_Agent_Security_Remediation.py"
Cohesion: 0.12
...
### Community 47 - "artifact.service.ts"
Cohesion: 0.13
...
### Community 52 - "Shore Sentinel v1.1.0 Release QA Scorecard — Template"
Cohesion: 0.18
...
### Community 53 - "UI/UX Review and Simplification Plan"
Cohesion: 0.18
...
### Community 54 - "API Surface Overview"
Cohesion: 0.18
...
### Community 58 - "test_production_compose_release_gate.py"
Cohesion: 0.20
...
### Community 59 - "app.module.ts"
Cohesion: 0.33
Nodes (6): name, version, scanner, additionalProperties, required, type

### Community 60 - "Shore Sentinel App-Wide Compact Operations Rollout Plan"
Cohesion: 0.20
...
### Community 61 - "SSH Managed-Machine Scan Controls Implementation Plan"
Cohesion: 0.20
...
### Community 64 - "Managed Machine Compact Dossier — UI/UX Quality Gate"
Cohesion: 0.22
...
### Community 70 - "Disposable SSH fixture contract and evidence harness"
Cohesion: 0.25
...
### Community 71 - "Worker-node egress ACL contract (operator evidence)"
Cohesion: 0.25
...
### Community 78 - "Shore Sentinel Token Efficiency Tracking"
Cohesion: 0.29
...
### Community 80 - "Security Model and Threat Boundaries"
Cohesion: 0.29
...
### Community 81 - "scanner-output.schema.json"
Cohesion: 0.15
...
### Community 82 - "Shore Sentinel scanner bundle contract"
Cohesion: 0.29
...
### Community 100 - "Docker Deployment Topology"
Cohesion: 0.40
...
### Community 102 - "Pull-Agent / Check-in Flow"
Cohesion: 0.67
Nodes (3): Flow, Intent, Pull-Agent / Check-in Flow

### Community 104 - "TokenEfficiencyTests"
Cohesion: 0.18
...
### Community 140 - "Path"
Cohesion: 0.24
Nodes (10): isInternalWorkerServiceRoute(), WORKER_SERVICE_ROUTES, bootstrap(), PUBLIC_PATHS, attachSessionPrincipal(), principalFrom(), RequestPrincipal, SessionRequest (+2 more)

### Community 141 - "validate_scanner_bundle.py"
Cohesion: 0.40
...
### Community 148 - "shore-sentinel-update.sh"
Cohesion: 0.80
...
### Community 153 - "@aws-sdk/s3-request-presigner"
Cohesion: 0.33
Nodes (7): assertSshLaunchRequirements(), canonicalHost(), deny(), LaunchInput, validCidr(), validIpv4(), validRoot()

## Knowledge Gaps
- **706 isolated node(s):** `name`, `version`, `private`, `type`, `build` (+701 more)
...
- **Why does `AppController` connect `AppController` to `index.js`, `queue.service.ts`, `ArtifactService`, `Archon Protocol Telegram Coordination Policy`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `Header()` connect `routePath` to `AppController`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `routePath()` connect `routePath` to `page.jsx`, `apiGet`, `getAuthenticatedUser`, `appPath`, `RemediationQueue`, `MachineDetailClient`, `page.jsx`, `ReportsLedger`, `display-preferences.js`, `InventoryRegistry`, `saved-views.jsx`?**
...
- **Should `AppController` be split into smaller, more focused modules?**
  _Cohesion score 0.05393548387096774 - nodes in this community are weakly interconnected._
