...
## Summary
- 2141 nodes · 3192 edges · 188 communities (139 shown, 49 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 95 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aeac9891`
...
### Community 5 - "app.controller.ts"
Cohesion: 0.09
Nodes (26): ARTIFACT_CONTENT_TYPES, assertSshEnrollment(), assertSshGrantControls(), parseSshPort(), PUBLIC_SCAN_RUN_EVENT, SshEnrollment, sshFingerprint(), sshSeal() (+18 more)
...
### Community 9 - "scanner-manifest.schema.json"
Cohesion: 0.06
...
### Community 12 - "MachineDetailClient"
Cohesion: 0.13
...
Cohesion: 0.13
Nodes (5): AppController, viewerRequest, Body, Controller, Res

### Community 15 - "routePath"
Cohesion: 0.09
Nodes (12): KB(), SavedViewsPage(), StartScanRedirect(), MobileNavigation(), Brand(), Empty(), Header(), NavigationGroups() (+4 more)

### Community 16 - "ArtifactService"
Cohesion: 0.11
...
### Community 17 - "Option 2 — App Deployment (install Shore Sentinel into Docker)"
Cohesion: 0.08
...
### Community 18 - "token_efficiency.py"
Cohesion: 0.18
...
### Community 30 - "managedSshProcessor.js"
Cohesion: 0.24
...
### Community 32 - "CompactOperationsComponentTests"
Cohesion: 0.12
...
### Community 36 - "sshExecutor.test.js"
Cohesion: 0.11
Nodes (3): CommandClient, ReadyClient, StageClient

### Community 37 - "App-Wide Compact Operations Test Guide"
Cohesion: 0.12
...
### Community 39 - "Shore Sentinel UI/UX QA Loop"
Cohesion: 0.12
...
### Community 48 - "Feature Update and DevOps Release Workflow"
Cohesion: 0.13
...
### Community 53 - "Archon Protocol Telegram Coordination Policy"
Cohesion: 0.14
...
### Community 55 - "Shore Sentinel v1.1.0 — Managed Machine Scan Controls and Hardware Summary"
Cohesion: 0.15
...
### Community 56 - "Agent Security Self-Check"
Cohesion: 0.15
...
### Community 68 - "migration-runner.ts"
Cohesion: 0.31
...
### Community 71 - "UI/UX Review and Simplification Plan"
Cohesion: 0.18
...
### Community 72 - "API Surface Overview"
Cohesion: 0.18
...
### Community 73 - "Shore Sentinel Change Request Form"
Cohesion: 0.18
...
### Community 74 - "run-scan-supervisor"
Cohesion: 0.25
...
### Community 75 - "collect_hardware_info"
Cohesion: 0.27
...
### Community 76 - "test_infrastructure_release_evidence.py"
Cohesion: 0.20
...
### Community 77 - "test_production_compose_release_gate.py"
Cohesion: 0.20
...
### Community 81 - "SSH Managed-Machine Scan Controls Implementation Plan"
Cohesion: 0.20
...
Cohesion: 0.42
Nodes (6): ARTIFACT_KIND, buildRunEvent(), JOB_STATUS, RUN_EVENT_TYPE, artifactUploadPayload(), lifecycleEvent()

### Community 84 - "Managed Machine Compact Dossier — UI/UX Quality Gate"
Cohesion: 0.22
...
### Community 92 - "Disposable SSH fixture contract and evidence harness"
Cohesion: 0.25
...
### Community 93 - "Worker-node egress ACL contract (operator evidence)"
Cohesion: 0.25
...
### Community 95 - "force-command-dispatch"
Cohesion: 0.29
...
### Community 103 - "Shore Sentinel Token Efficiency Tracking"
Cohesion: 0.29
...
### Community 104 - "Recommended Architecture"
Cohesion: 0.29
...
### Community 105 - "Security Model and Threat Boundaries"
Cohesion: 0.29
...
### Community 106 - "Shore Sentinel scanner bundle contract"
Cohesion: 0.29
...
### Community 108 - "compose_smoke.py"
Cohesion: 0.57
...
### Community 112 - "data.js"
Cohesion: 0.29
Nodes (5): audits, machines, navGroups, remediations, reports

### Community 114 - "Local Compose runbook"
Cohesion: 0.33
...
### Community 116 - "schema.placeholder.json"
Cohesion: 0.33
...
### Community 118 - "scanner-output.schema.json"
Cohesion: 0.33
...
### Community 129 - "Single-container backup, restore, and rollback"
Cohesion: 0.40
Nodes (4): Backup, Restore drill, Rollback primitive, Single-container backup, restore, and rollback

### Community 130 - "Product Logic and Operating Modes"
Cohesion: 0.40
...
### Community 131 - "Docker Deployment Topology"
Cohesion: 0.40
...
- **Why does `AppController` connect `AppController` to `app.controller.ts`, `.query`, `app.module.ts`, `ArtifactService`, `.createJob`, `queue.service.ts`, `tenant-controller.test.ts`, `controller-shapes.test.ts`, `QueueService`, `scannerBundleContractVersion`, `worker-ssh-grant.test.ts`, `Post`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `Header()` connect `routePath` to `AppController`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `routePath()` connect `routePath` to `apiGet`, `appPath`, `display-preferences.js`, `saved-views.jsx`, `page.jsx`, `ReportsLedger`, `MachineDetailClient`, `getAuthenticatedUser`, `InventoryRegistry`, `page.jsx`, `RemediationQueue`?**
