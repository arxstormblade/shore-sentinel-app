...
- [[_COMMUNITY_queue.service.ts|queue.service.ts]]
...
- [[_COMMUNITY_MachineDetailClient|MachineDetailClient]]
...
- [[_COMMUNITY_authorization.service.ts|authorization.service.ts]]
- [[_COMMUNITY_routePath|routePath]]
- [[_COMMUNITY_ArtifactService|ArtifactService]]
- [[_COMMUNITY_managedSshProcessor.js|managedSshProcessor.js]]
- [[_COMMUNITY_scanner-manifest.schema.json|scanner-manifest.schema.json]]
- [[_COMMUNITY_scannerRunner.js|scannerRunner.js]]
- [[_COMMUNITY_SessionService|SessionService]]
- [[_COMMUNITY_2026-07-22-enterprise-single-container-requirements.json|2026-07-22-enterprise-single-container-requirements.json]]
- [[_COMMUNITY_properties|properties]]
- [[_COMMUNITY_Option 2 — App Deployment (install Shore Sentinel into Docker)|Option 2 — App Deployment (install Shore Sentinel into Docker)]]
...
- [[_COMMUNITY_$ref|$ref]]
- [[_COMMUNITY_sshExecutor.js|sshExecutor.js]]
- [[_COMMUNITY_entrypoint.sh|entrypoint.sh]]
- [[_COMMUNITY_envdetect.py|envdetect.py]]
- [[_COMMUNITY_oidc-validator.ts|oidc-validator.ts]]
- [[_COMMUNITY_Shore Sentinel Enterprise Single-Container Completion Plan|Shore Sentinel Enterprise Single-Container Completion Plan]]
- [[_COMMUNITY_$defs|$defs]]
- [[_COMMUNITY_apiGet|apiGet]]
- [[_COMMUNITY_Shore Sentinel v1.1 SSH-Push Security Decision (Historical)|Shore Sentinel v1.1 SSH-Push Security Decision (Historical)]]
- [[_COMMUNITY_Shore Sentinel Control Plane Architecture Proposal|Shore Sentinel Control Plane Architecture Proposal]]
...
- [[_COMMUNITY_App-Wide Compact Operations Test Guide|App-Wide Compact Operations Test Guide]]
- [[_COMMUNITY_Key fields|Key fields]]
- [[_COMMUNITY_Shore Sentinel UIUX QA Loop|Shore Sentinel UI/UX QA Loop]]
- [[_COMMUNITY_coverage|coverage]]
- [[_COMMUNITY_saved-views.jsx|saved-views.jsx]]
- [[_COMMUNITY_Shore Sentinel Release Checklist|Shore Sentinel Release Checklist]]
- [[_COMMUNITY_index.js|index.js]]
- [[_COMMUNITY_DatabaseService|DatabaseService]]
- [[_COMMUNITY_Managed Machine Compact Dossier Design|Managed Machine Compact Dossier Design]]
- [[_COMMUNITY_Feature Update and DevOps Release Workflow|Feature Update and DevOps Release Workflow]]
- [[_COMMUNITY_ARX_Agent_Security_Remediation.py|ARX_Agent_Security_Remediation.py]]
...
- [[_COMMUNITY_Archon Protocol Telegram Coordination Policy|Archon Protocol Telegram Coordination Policy]]
- [[_COMMUNITY_target|target]]
- [[_COMMUNITY_decision|decision]]
- [[_COMMUNITY_scanner|scanner]]
- [[_COMMUNITY_compilerOptions|compilerOptions]]
- [[_COMMUNITY_Shore Sentinel v1.1.0 — Managed Machine Scan Controls and Hardware Summary|Shore Sentinel v1.1.0 — Managed Machine Scan Controls and Hardware Summary]]
- [[_COMMUNITY_Agent Security Self-Check|Agent Security Self-Check]]
- [[_COMMUNITY_ManagedMachineDossierTests|ManagedMachineDossierTests]]
...
- [[_COMMUNITY_display-preferences.js|display-preferences.js]]
- [[_COMMUNITY_AccessGovernanceService|AccessGovernanceService]]
- [[_COMMUNITY_migration-runner.ts|migration-runner.ts]]
- [[_COMMUNITY_Shore Sentinel v1.1.0 Release QA Scorecard — Template|Shore Sentinel v1.1.0 Release QA Scorecard — Template]]
...
- [[_COMMUNITY_test_production_compose_release_gate.py|test_production_compose_release_gate.py]]
...
- [[_COMMUNITY_.token|.token]]
- [[_COMMUNITY_UpdateService|UpdateService]]
- [[_COMMUNITY_Managed Machine Compact Dossier — UIUX Quality Gate|Managed Machine Compact Dossier — UI/UX Quality Gate]]
- [[_COMMUNITY_load_and_validate|load_and_validate]]
- [[_COMMUNITY_SingleContainerComposeTests|SingleContainerComposeTests]]
- [[_COMMUNITY_SingleContainerPersistenceContractTests|SingleContainerPersistenceContractTests]]
- [[_COMMUNITY_middleware.js|middleware.js]]
- [[_COMMUNITY_payloadContract.test.js|payloadContract.test.js]]
- [[_COMMUNITY_Managed Machine Compact Dossier Implementation Plan|Managed Machine Compact Dossier Implementation Plan]]
...
- [[_COMMUNITY_Shore Sentinel Token Efficiency Tracking|Shore Sentinel Token Efficiency Tracking]]
...
- [[_COMMUNITY_RemoveInAppOneTimeAuditTests|RemoveInAppOneTimeAuditTests]]
...
- [[_COMMUNITY_Product Logic and Operating Modes|Product Logic and Operating Modes]]
- [[_COMMUNITY_Docker Deployment Topology|Docker Deployment Topology]]
- [[_COMMUNITY_items|items]]
- [[_COMMUNITY_shore-sentinel-update.sh|shore-sentinel-update.sh]]
- [[_COMMUNITY_read|read]]
...
- [[_COMMUNITY_scan-run-cancel-proxy.test.mjs|scan-run-cancel-proxy.test.mjs]]
- [[_COMMUNITY_config.js|config.js]]
- [[_COMMUNITY_backup-restore.sh|backup-restore.sh]]
- [[_COMMUNITY_Dashboard  Analytics Model|Dashboard / Analytics Model]]
- [[_COMMUNITY_Report Ingestion and Artifact Flow|Report Ingestion and Artifact Flow]]
- [[_COMMUNITY_SSH Push Flow|SSH Push Flow]]
- [[_COMMUNITY_validate_scanner_bundle.py|validate_scanner_bundle.py]]
- [[_COMMUNITY_single_container_runtime_smoke.sh|single_container_runtime_smoke.sh]]
- [[_COMMUNITY_InventoryRegistry|InventoryRegistry]]
- [[_COMMUNITY_verify-machine-data.mjs|verify-machine-data.mjs]]
- [[_COMMUNITY_verify-machine-dossier.mjs|verify-machine-dossier.mjs]]
...
- [[_COMMUNITY_async-cookie-server-helpers.test.mjs|async-cookie-server-helpers.test.mjs]]
- [[_COMMUNITY_machine-directory-selection.test.mjs|machine-directory-selection.test.mjs]]
- [[_COMMUNITY_machine-hardware-summary.test.mjs|machine-hardware-summary.test.mjs]]
- [[_COMMUNITY_scannerV35Contract.test.js|scannerV35Contract.test.js]]
- [[_COMMUNITY_README|README.md]]
- [[_COMMUNITY_capability-check.sh|capability-check.sh]]
- [[_COMMUNITY_object-storage-bootstrap.mjs|object-storage-bootstrap.mjs]]
- [[_COMMUNITY_README|README.md]]
- [[_COMMUNITY_refresh_graphify.sh|refresh_graphify.sh]]
- [[_COMMUNITY_next.config.js|next.config.js]]
- [[_COMMUNITY_README|README.md]]
- [[_COMMUNITY_verify-machine-status.mjs|verify-machine-status.mjs]]
- [[_COMMUNITY_new-machine-enrollment.test.mjs|new-machine-enrollment.test.mjs]]
- [[_COMMUNITY_README|README.md]]
- [[_COMMUNITY_README|README.md]]
...
3. `parse_scanner_output()` - 30 edges
4. `DatabaseService` - 29 edges
5. `main()` - 25 edges
6. `ParserTests` - 24 edges
7. `Shore Sentinel Control Plane Architecture Proposal` - 24 edges
8. `get()` - 23 edges
9. `output()` - 23 edges
10. `ArtifactService` - 21 edges
...
- `validateCoverage()` --indirect_call--> `key()`  [INFERRED]
  workers/worker-node/src/scannerRunner.js → api/src/identity/mfa.service.ts
- `HighFindingsView()` --indirect_call--> `finding()`  [INFERRED]
  web/components/saved-views.jsx → workers/worker-python/test/test_parser.py
...
### Community 0 - "Agent_Security_Selfcheck_v3.5.0.py"
Cohesion: 0.09
...
### Community 3 - "Agent Security Self-Check Version History"
Cohesion: 0.04
...
### Community 5 - "queue.service.ts"
Cohesion: 0.08
Nodes (21): positiveInteger(), QUEUE_NAMES, QueueName, QueueService, ScanDispatchDeliveryFailure, scanDispatchJobOptions(), scanDispatchRetryDelayMs(), scanRetryPolicy (+13 more)

### Community 6 - "parse_scanner_output"
Cohesion: 0.14
Nodes (15): extract_cve_info(), normalize_finding(), normalize_severity(), _now(), parse_scanner_output(), ParseResult, Any, _reference_texts() (+7 more)

### Community 7 - "app.controller.ts"
Cohesion: 0.08
Nodes (23): ARTIFACT_CONTENT_TYPES, assertSshEnrollment(), parseSshPort(), PUBLIC_SCAN_RUN_EVENT, requireUuid(), SshEnrollment, sshFingerprint(), sshSeal() (+15 more)

### Community 8 - ".query"
Cohesion: 0.19
Nodes (5): Delete, Get, Param, Patch, Req

### Community 9 - "ParserServerTests"
Cohesion: 0.10
Nodes (6): BaseHTTPRequestHandler, ProxyHandler, upstream_path(), Handler, main(), ParserServerTests
...
Cohesion: 0.06
Nodes (32): minLength, type, type, type, type, type, type, $ref (+24 more)

### Community 15 - "Post"
Cohesion: 0.17
Nodes (6): assertSshGrantControls(), sshUnseal(), requireString(), requireWorkerAttempt(), Body, Post
...
### Community 17 - "authorization.service.ts"
Cohesion: 0.10
...
### Community 18 - "routePath"
Cohesion: 0.08
Nodes (12): KB(), SavedViewsPage(), StartScanRedirect(), MobileNavigation(), SavedViewContent(), Brand(), Empty(), NavigationGroups() (+4 more)

### Community 19 - "ArtifactService"
Cohesion: 0.11
...
### Community 20 - "managedSshProcessor.js"
Cohesion: 0.20
...
### Community 21 - "scanner-manifest.schema.json"
Cohesion: 0.07
Nodes (26): additionalProperties, properties, required, type, const, const, description, $id (+18 more)

### Community 22 - "scannerRunner.js"
Cohesion: 0.15
...
### Community 24 - "2026-07-22-enterprise-single-container-requirements.json"
Cohesion: 0.08
...
### Community 26 - "Option 2 — App Deployment (install Shore Sentinel into Docker)"
Cohesion: 0.08
...
### Community 27 - "test_scanner_bundle_v35.py"
Cohesion: 0.15
Nodes (22): load_scanner(), Path, run_report(), test_active_compose_socket_mount_is_high_confidence_target_finding(), test_decode_and_config_parse_loss_make_coverage_incomplete(), test_example_socket_mount_is_not_active_target_exposure(), test_explicitly_selected_development_compose_is_treated_as_active(), test_external_symlink_is_reported_and_not_scanned() (+14 more)

### Community 28 - "type"
Cohesion: 0.09
Nodes (23): items, type, items, type, items, type, minLength, type (+15 more)

### Community 29 - "AppController"
Cohesion: 0.16
...
### Community 35 - "oidc-validator.ts"
Cohesion: 0.12
...
### Community 36 - "Shore Sentinel Enterprise Single-Container Completion Plan"
Cohesion: 0.10
...
### Community 39 - "Shore Sentinel v1.1 SSH-Push Security Decision (Historical)"
Cohesion: 0.11
...
### Community 40 - "Shore Sentinel Control Plane Architecture Proposal"
Cohesion: 0.11
...
### Community 43 - "getAuthenticatedUser"
Cohesion: 0.11
...
### Community 52 - "Shore Sentinel UI/UX QA Loop"
Cohesion: 0.12
...
### Community 55 - "Shore Sentinel Release Checklist"
Cohesion: 0.12
...
### Community 59 - "Feature Update and DevOps Release Workflow"
Cohesion: 0.13
...
### Community 62 - "controller-shapes.test.ts"
Cohesion: 0.18
...
Cohesion: 0.14
Nodes (13): Changelog, Unreleased, v0.1.0, v0.1.1, v0.3.10, v0.3.5, v0.3.6, v0.3.7 (+5 more)

### Community 64 - "Vertical implementation slices (TDD)"
Cohesion: 0.14
...
### Community 65 - "Archon Protocol Telegram Coordination Policy"
Cohesion: 0.14
...
### Community 68 - "scanner"
Cohesion: 0.14
Nodes (14): minLength, type, name, scanner, scriptSha256, version, additionalProperties, properties (+6 more)
...
### Community 70 - "Shore Sentinel v1.1.0 — Managed Machine Scan Controls and Hardware Summary"
Cohesion: 0.15
...
### Community 71 - "Agent Security Self-Check"
Cohesion: 0.15
...
### Community 84 - "migration-runner.ts"
Cohesion: 0.31
...
### Community 85 - "Shore Sentinel v1.1.0 Release QA Scorecard — Template"
Cohesion: 0.18
...
### Community 86 - "UI/UX Review and Simplification Plan"
Cohesion: 0.18
...
### Community 87 - "API Surface Overview"
Cohesion: 0.18
...
### Community 88 - "Shore Sentinel Change Request Form"
Cohesion: 0.18
...
### Community 90 - "test_infrastructure_release_evidence.py"
Cohesion: 0.20
...
### Community 91 - "test_production_compose_release_gate.py"
Cohesion: 0.20
...
### Community 92 - "Shore Sentinel App-Wide Compact Operations Rollout Plan"
Cohesion: 0.20
...
### Community 93 - "SSH Managed-Machine Scan Controls Implementation Plan"
Cohesion: 0.20
...
### Community 95 - ".token"
Cohesion: 0.22
Nodes (3): request, Header, Res

### Community 96 - "UpdateService"
Cohesion: 0.28
Nodes (4): Injectable, UpdateMode, UpdateResult, UpdateService

### Community 97 - "Managed Machine Compact Dossier — UI/UX Quality Gate"
Cohesion: 0.22
...
### Community 104 - "Disposable SSH fixture contract and evidence harness"
Cohesion: 0.25
...
### Community 105 - "Worker-node egress ACL contract (operator evidence)"
Cohesion: 0.25
...
### Community 110 - "Shore Sentinel Token Efficiency Tracking"
Cohesion: 0.29
...
### Community 111 - "Recommended Architecture"
Cohesion: 0.29
...
### Community 112 - "Security Model and Threat Boundaries"
Cohesion: 0.29
...
### Community 113 - "Shore Sentinel scanner bundle contract"
Cohesion: 0.29
...
### Community 114 - "scanner-output.schema.json"
Cohesion: 0.29
Nodes (6): additionalProperties, $id, required, $schema, title, type

### Community 115 - "compose_smoke.py"
Cohesion: 0.57
...
### Community 119 - "data.js"
Cohesion: 0.29
Nodes (5): audits, machines, navGroups, remediations, reports

### Community 120 - "Local Compose runbook"
Cohesion: 0.33
...
### Community 132 - "Single-container backup, restore, and rollback"
Cohesion: 0.40
Nodes (4): Backup, Restore drill, Rollback primitive, Single-container backup, restore, and rollback

### Community 133 - "Product Logic and Operating Modes"
Cohesion: 0.40
...
### Community 134 - "Docker Deployment Topology"
Cohesion: 0.40
...
- **Why does `finding()` connect `parse_scanner_output` to `saved-views.jsx`, `scannerRunner.js`?**
...
- **Are the 23 inferred relationships involving `parse_scanner_output()` (e.g. with `.do_POST()` and `.test_parse_preserves_v35_evidence_provenance_fields()`) actually correct?**
  _`parse_scanner_output()` has 23 INFERRED edges - model-reasoned connections that need verification._
- **What connects `name`, `version`, `private` to the rest of the system?**
  _905 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Agent_Security_Selfcheck_v3.5.0.py` be split into smaller, more focused modules?**
