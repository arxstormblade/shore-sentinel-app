...
- [[_COMMUNITY_SignInForm|SignInForm]]
...
Cohesion: 0.07
Nodes (20): AppController, assertSshEnrollment(), requireUuid(), AccessGovernanceService, Injectable, requireString(), requireWorkerAttempt(), validateScanTarget() (+12 more)
...
Cohesion: 0.07
Nodes (15): BaseHTTPRequestHandler, ProxyHandler, upstream_path(), extract_cve_info(), normalize_finding(), normalize_severity(), _now(), parse_scanner_output() (+7 more)
...
Cohesion: 0.08
Nodes (23): ARTIFACT_CONTENT_TYPES, assertSshGrantControls(), parseSshPort(), PUBLIC_SCAN_RUN_EVENT, SshEnrollment, sshFingerprint(), sshSeal(), sshUnseal() (+15 more)
...
Cohesion: 0.06
Nodes (30): name, sharp, overrides, next, postcss, sharp, private, scripts (+22 more)

### Community 12 - "routePath"
Cohesion: 0.08
Nodes (13): Register(), KB(), SavedViewsPage(), StartScanRedirect(), MobileNavigation(), NewMachineForm(), Brand(), Empty() (+5 more)
...
Cohesion: 0.16
Nodes (18): SavedViewSlugPage(), ALL_VIEW_SLUGS, FailedScansView(), formatTime(), getJson(), HighFindingsView(), readableText(), RecentlyCompletedView() (+10 more)
...
## Knowledge Gaps
- **767 isolated node(s):** `name`, `version`, `private`, `type`, `build` (+762 more)
...
- **Why does `key()` connect `mfa.service.ts` to `appPath`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `coercePayload()` connect `appPath` to `mfa.service.ts`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `appPath()` connect `appPath` to `users-api.js`, `MachineDetailClient`, `routePath`, `SignInForm`, `getAuthenticatedUser`?**
