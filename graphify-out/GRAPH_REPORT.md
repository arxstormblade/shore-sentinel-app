...
## Corpus Check
- 213 files · ~274,851 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2061 nodes · 3115 edges · 179 communities (132 shown, 47 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 92 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4dd47b93`
...
- admin-tenant-mutations.test.ts
- scan-run-events.test.ts
...
### Community 0 - "Agent_Security_Selfcheck_v3.4.0.py"
Cohesion: 0.11
...
### Community 1 - "Agent Security Self-Check Version History"
Cohesion: 0.05
...
### Community 2 - "2026-07-22-enterprise-single-container-requirements.json"
Cohesion: 0.05
Nodes (42): approval_scope, authorized, excluded, approved_by, approved_on, architecture_spec, baseline_commit, delivery_contract (+34 more)
...
### Community 6 - "app.controller.ts"
Cohesion: 0.11
Nodes (23): ARTIFACT_CONTENT_TYPES, assertSshEnrollment(), assertSshGrantControls(), parseSshPort(), PUBLIC_SCAN_RUN_EVENT, SshEnrollment, sshFingerprint(), sshSeal() (+15 more)

### Community 7 - "Route treatment"
Cohesion: 0.06
...
### Community 8 - "scanner-manifest.schema.json"
Cohesion: 0.06
...
Cohesion: 0.09
Nodes (11): Register(), KB(), SavedViewsPage(), NewMachineForm(), Brand(), Empty(), Header(), Shell() (+3 more)
...
Cohesion: 0.08
Nodes (24): 1. Clone the repository, 2. Configure environment values, 3. Validate the Compose model, 4. Start Shore Sentinel, 5. Check application health, 6. Stop the stack, Application process wiring, Graphify navigation (+16 more)

### Community 19 - "AppController"
Cohesion: 0.13
Nodes (5): AppController, validateScanTarget(), viewerRequest, viewerRequest, Controller

### Community 20 - "token_efficiency.py"
Cohesion: 0.18
...
Cohesion: 0.11
Nodes (18): 95+ evidence matrix, Current baseline used by this plan, Dependency order and implementation tasks, Locked decisions and constraints, Migration and data-safety contract, Requirement register, Rollback and review boundary, Shore Sentinel Enterprise Single-Container Completion Plan (+10 more)
...
### Community 33 - "managedSshProcessor.js"
Cohesion: 0.24
...
### Community 34 - "CompactOperationsComponentTests"
Cohesion: 0.12
...
### Community 40 - "Shore Sentinel UI/UX QA Loop"
Cohesion: 0.12
...
### Community 42 - "Shore Sentinel Control Plane Architecture Proposal"
Cohesion: 0.12
...
### Community 43 - "Shore Sentinel Release Checklist"
Cohesion: 0.12
...
### Community 46 - "Managed Machine Compact Dossier Design"
Cohesion: 0.13
...
### Community 47 - "Feature Update and DevOps Release Workflow"
Cohesion: 0.13
...
### Community 52 - "Archon Protocol Telegram Coordination Policy"
Cohesion: 0.14
...
### Community 54 - "Shore Sentinel v1.1.0 — Managed Machine Scan Controls and Hardware Summary"
Cohesion: 0.15
...
### Community 55 - "Agent Security Self-Check"
Cohesion: 0.15
...
### Community 69 - "run-scan-supervisor"
Cohesion: 0.25
...
### Community 71 - "test_infrastructure_release_evidence.py"
Cohesion: 0.20
...
### Community 72 - "test_production_compose_release_gate.py"
Cohesion: 0.20
...
### Community 84 - "payloadContract.test.js"
Cohesion: 0.33
Nodes (4): createParserClient(), serializeParserRequest(), grant, job

### Community 86 - "request-principal.ts"
Cohesion: 0.39
...
### Community 91 - "force-command-dispatch"
Cohesion: 0.29
...
### Community 121 - "v0.3.0 - Product-roadmap epic release"
Cohesion: 0.40
...
### Community 122 - "Product Logic and Operating Modes"
Cohesion: 0.40
...
### Community 123 - "Docker Deployment Topology"
Cohesion: 0.40
...
- **Why does `AppController` connect `AppController` to `index.js`, `app.controller.ts`, `app.module.ts`, `queue.service.ts`, `.query`, `admin-tenant-mutations.test.ts`, `scan-run-events.test.ts`, `tenant-controller.test.ts`, `ArtifactService`, `Body`, `Post`, `worker-ssh-grant.test.ts`, `scannerBundleContractVersion`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `Header()` connect `routePath` to `Body`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `routePath()` connect `routePath` to `ReportsLedger`, `apiGet`, `appPath`, `InventoryRegistry`, `MachineDetailClient`, `getAuthenticatedUser`, `page.jsx`, `RemediationQueue`, `SignInForm`, `display-preferences.js`, `saved-views.jsx`?**
...
- **Should `Agent Security Self-Check Version History` be split into smaller, more focused modules?**
